...
## Currently, there is a problem with deployment so no live preview :(
...
## In the future
- A proper database and an admin panel to add/remove/update text entries. 
- Client-side persistent high score calculation
